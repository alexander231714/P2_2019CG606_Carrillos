...
namespace P2_2019CG606.Controllers
{
    public class departamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_departamentos,nombre")] departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_departamentos,nombre")] departamentos departamentos)
        {
